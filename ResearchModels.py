...
"""
from tensorflow.keras.layers import Dense, Flatten,Activation, Dropout, ZeroPadding3D,BatchNormalization
...
class ResearchModels():
    def __init__(self, nb_classes, model, height, width, seq_length,
        ...
        if self.saved_model is not None:
            ...
            self.input_shape = (seq_length, height, width, 3)
